...
public class MusicService extends Service implements PlayMusicInterface,
    ...
    private static final int VALUE_NEXT_SONG = 9000;
    private static final int VALUE_PREVIOUS_SONG = 9100;
    private static final int VALUE_PAUSE_SONG = 9200;
    private static final int VALUE_PLAY_SONG = 9300;
