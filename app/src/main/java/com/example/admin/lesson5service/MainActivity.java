...
public class MainActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    private ImageButton mButtonPlay, mButtonPause, mButtonNext, mButtonPrev;
    private TextView mTextTitle, mCurrentSongTime, mDurationSongTime;
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            mCurrentSongTime.setText(convertMilisecondToFormatTime(currentPosition));
    ...
    private void initViews() {
        ...
        SongAdapter musicAdapter = new SongAdapter(mSongs, this);
    ...
    public void syncSeekbar(int max) {
        mSeekBar.setMax(max);
        mDurationSongTime.setText(convertMilisecondToFormatTime(max));
    }
